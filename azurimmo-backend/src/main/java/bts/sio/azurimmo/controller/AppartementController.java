...
public class AppartementController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Récupérer un appartement par son ID")
    public Optional<AppartementDTO> getAppartement(@PathVariable Long id) {
        return appartementService.getAppartementDTO(id);
    }
    
    @GetMapping("/")
    @Operation(summary = "Récupérer tous les appartements")
